...
export const BlogView = (props: BlogViewProps) => {
  ...
  return (
    <>
      <Header
				theme={theme}
				className={'container-xl pt-128 pb-64 container-sm'}
			...
			<div className={'container-xl layout-align-center-center layout-column'}>
				{posts && posts.length > 4
					...
					: <S.Form onSubmit={subscribe} className={clsx(theme === 'dark' ? 'bg-primary-100' : 'bg-primary-900', 'layout-column layout-align-start-stretch p-32 rounded-lg flex')}>
