  ...
  return (
    <Link href={`${type ? type.slug : topic.typeSlug}/${topic.slug}`}>
      <article className={clsx(className, "cursor-pointer")}>
        <S.Shape
          className={
            "bg-primary-900 width-100 relative cursor-pointer layout-column layout-align-end-stretch text-center overflow-hidden rounded-xl shadow-3"
          }
        >
          <S.Main
            className={"p-16 content layout-column layout-align-center-center"}
          >
            <S.Title className={"text-primary-100 h2 strong mb-8"}>
              {topic.name}
            </S.Title>
            <span
              className={"p text-capitalize text-primary-100"}
              style={{ opacity: 0.5 }}
            >
          ...
          >
            {topic._count.articles > 0 ? (
              <>
                <span
                  className={
                    "small text-left flex text-primary-100 text-truncate"
                  }
                >
                ...
                <S.IconButton
                  className={
                    "text-primary-100 layout layout-align-center-center p-8 rounded"
                  }
                >
              ...
              <S.Soon
                className={"flex small py-8 px-16 rounded-sm text-primary-100"}
              >
                Coming soon
              </S.Soon>
            )}
