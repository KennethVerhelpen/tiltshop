		...
		<footer className="py-64">
			<div className="container-md layout-row layout-align-center-center">
				<div className="layout-column layout-align-start-center text-center">
					...
					<p className="small mb-32 text-secondary-600">
						Every item is hand-picked from Amazon catalogue and sorted out just for you.
					</p>
					<p className="small lh-1 text-secondary-500" ><i>Tiltshop.com</i> is a participant in the <i>Amazon Services LLC Associates Program</i>, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to <i>amazon.com.</i></p>
				</div>
			</div>
		</footer>
	);
